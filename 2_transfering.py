...
with model:
    ...
    nengo.Connection(e2, c2.learning_rule)
    nengo.Connection(p1, c3.learning_rule)
    nengo.Connection(p2, c4.learning_rule)
    
    nengo.Connection(e1, v2, function=func1)
    nengo.Connection(e2, v1, function=func1)
    nengo.Connection(p1, v2, function=func2)
    nengo.Connection(p2, v1, function=func2)
